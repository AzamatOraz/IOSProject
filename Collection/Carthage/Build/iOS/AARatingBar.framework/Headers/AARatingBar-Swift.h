...
SWIFT_MODULE_NAMESPACE_PUSH("AARatingBar")
@class UIColor;
@class NSCoder;

SWIFT_CLASS("_TtC11AARatingBar11AARatingBar")
@interface AARatingBar : UIView
/// AARatingBar filled icon
@property (nonatomic, copy) NSString * _Nonnull filledIcon;
/// AARatingBar un filled icon
@property (nonatomic, copy) NSString * _Nonnull unFilledIcon;
/// AARatingBar change listner
@property (nonatomic, copy) void (^ _Nullable ratingDidChange)(CGFloat);
...
@property (nonatomic) BOOL isAbsValue;
